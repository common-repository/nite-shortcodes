...
function nite_shortcodes_tinymce() {
    $tinymce_button = new nite_shortcodes_button();
}
add_action( 'after_setup_theme', 'nite_shortcodes_tinymce' );
?>